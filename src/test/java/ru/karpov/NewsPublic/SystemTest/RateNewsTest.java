...
public class RateNewsTest {
    @Test
    public void addRateToNews() {
        Assertions.assertEquals(2, 1+1);
=======
<<<<<<<< HEAD:src/test/java/ru/karpov/NewsPublic/SystemTest/RateNewsTest.java
...
public class LoginTest {
    ...
    public void userCanLoginByUsername() {
        Assertions.assertEquals(2, 1+1);
>>>>>>>> origin/main:src/test/java/ru/karpov/NewsPublic/SystemTest/LoginTest.java
>>>>>>> origin/main
    }
}
